<!-- Brand Logo -->
<a href="{{ route('teacher.profile') }}" class="brand-link">
...
<div class="sidebar">
	...
	<nav class="mt-2">
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<li class="nav-item">
				<a href="{{ route('teacher.result.index') }}" class="nav-link {{ request()->is('teacher/result*') ? 'active' : '' }}">
					<i class="nav-icon fas fa-cog"></i>
			...
			{{-- <li class="nav-item">
				<a href="" class="nav-link">
					<i class="nav-icon fas fa-cog"></i>
					<p class="text">Attendence</p>
				</a>
			</li> --}}

			<li class="nav-header">SETTINGS</li>
			<li class="nav-item">
				<a href="{{ route('teacher.destroy') }}" class="nav-link">
