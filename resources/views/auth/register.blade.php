					...
					<div class="card2 card border-0 px-4 py-5">
						...
						<form method="POST" action="{{ route('register') }}">
							...
							<div class="row px-3">
								...
								<input class="mb-3" type="text" name="name" placeholder="Enter a full name" value="{{ old('name') }}">
							</div>
							<div class="row px-3">
								<label class="mb-1">
							...
							<div class="row px-3 mb-3">
								<label class="mb-1">
									<h6 class="mb-0 text-sm">Conform Password</h6>
								</label>
							...
							{{-- <div class="row px-3 mb-3">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input type="checkbox" name="agree_terms" id="agree_terms" class="custom-control-input">
									<label for="agree_terms" class="custom-control-label text-sm">
						...
						<div class="row mb-3 px-3">
							<small class="font-weight-bold">I am already member? <a href="{{ route('login') }}"
