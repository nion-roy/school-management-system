		...
		<div class="card">
			<div class="card-header">
				<div class="d-flex align-items-center justify-content-between">
					<h3 class="card-title">All Users <span class="badge badge-success"></span></h3>
					<a href="{{ route('admin.slider.create') }}" class="btn btn-success waves-effect"><i class="fas fa-plus mr-1"></i> Add User</a>
				</div>
			</div>
			<!-- /.card-header -->
			<div class="card-body">
