	...
	<div class="col-sm-12">
		...
		<div class="card">
			<div class="card-header">
				<h5>Add Exam Notice</h5>
			</div>
			<div class="card-body">

				<form action="{{ route('admin.exam-routine.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group row">
						<div class="offset-sm-2 col-sm-10">
							...
							<a href="{{ route('admin.exam-routine.index') }}" class="btn btn-success waves-effect float-right mr-2"> <i class="fas fa-arrow-left mr-1"></i> Back</a>
						</div>
					</div>
				</form>
