...
@section('title', 'Add Important News')
	...
	<div class="col-sm-12">
		...
		<div class="card">
			<div class="card-header">
				<h5>Add Important News</h5>
			</div>
			<div class="card-body">

				<form action="{{ route('admin.important-news.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-sm-1 text-center d-none d-sm-block">:</div>
						<div class="col-xl-10 col-sm-8">
							<input type="text" name="links" class="form-control" placeholder="Enter Links" value="{{ old('links') }}">
						</div>
					</div>
