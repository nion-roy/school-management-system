			...
			<div class="card-body">
				...
				<form action="{{ route('admin.section.update', $section->id) }}" method="post">
					...
					<div class="form-group row align-items-center">
						...
						<div class="col-md-9 col-12"><input type="text" name="section" placeholder="Enter Section" class="form-control" value="{{ $section->section }}"></div>
					</div>
					...
					<div class="form-group row align-items-center">
						...
						<div class="col-md-9 col-8">
							<div class="custom-control custom-checkbox">
								<input class="custom-control-input custom-control-input-danger" type="checkbox" id="customCheckbox4" name="status" {{ $section->status == true ? 'checked' : '' }}>
