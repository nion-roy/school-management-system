				...
				<form action="{{ route('admin.announcement.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<div class="offset-sm-2 col-sm-10">
							...
							<a href="{{ route('admin.announcement.index') }}" class="btn btn-success waves-effect float-right mr-2"> <i class="fas fa-arrow-left mr-1"></i> Back</a>
						</div>
					</div>
				</form>
