			...
			<div class="card-body">
				...
				<form action="{{ route('admin.speech.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-xl-9 col-sm-8">
							<select name="speech_type" id="" class="form-control">
								...
								<option value="Chairman Speech">Chairman's Speech</option>
								<option value="Principal Speech">Principal's Speech</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-1 text-center d-none d-sm-block">:</div>
						<div class="col-xl-9 col-sm-8">
							<textarea id="summernote" class="form-control" name="speech"></textarea>
						</div>
					</div>
