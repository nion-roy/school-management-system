...
@section('title', 'Create Mission Information')
				...
				<form action="{{ route('admin.mission.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-xl-9 col-sm-8">
							<input type="text" name="title" class="form-control" placeholder="Enter Mission Title" value="{{ old('title') }}">
						</div>
					</div>
